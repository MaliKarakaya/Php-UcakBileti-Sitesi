...
<head>
  ...
  <title>Sadece Uç | Giriş Yap</title>
  <meta charset="utf-8">
...
<h1>Giriş Yap </h1>
			...
			<input type="hidden" name="redirurl" value="<? echo $_SERVER['HTTP_REFERER']; ?>" />
			 ...
			 <div class="col-xs-12 col-sm-12 col-md-4 col-sm-offset-4 col-xs-offset-2 col-md-offset-4" >
                    <label for = "firstname">Email : </label><input class="form-control" name="username" id = "username" placeholder="email adresimiz" type="text" required autofocus />
                   <label for = "lasttname">Şifre: </label><input class="form-control" name="password" id = "password" placeholder="sifreniz" type="password" required />
            <br />
            <br />
